...
import { ArrowRight, Shield, HeartPulse, Car, ShieldCheck, Truck, CalendarDays, Users } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Jeep Tour & Rental Insurance Services",
  description: `Complete insurance coverage for commercial Jeep tour and rental operators — general liability, participant accident, rental fleet physical damage, abuse & molestation liability, commercial auto, special event liability, and workers comp. ${SITE.statesLicensed}.`,
};

const ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  Shield, HeartPulse, Car, ShieldCheck, Truck, CalendarDays, Users,
};
        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Jeep Tour & Rental Insurance</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Every policy a commercial Jeep tour or rental operator needs — in one place, from specialists who know off-road recreation.
              </p>
            </FadeIn>
          </div>
        </section>
