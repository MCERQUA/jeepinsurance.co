...
export const metadata: Metadata = {
  title: "Jeep Tour & Rental Insurance Blog",
  description: `Guides on general liability, participant accident, rental fleet coverage, and special event liability for commercial Jeep tour and rental operators. Expert advice from ${SITE.name}.`,
};
      ...
      <main>
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Jeep Insurance Blog</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Expert guides on insurance for commercial Jeep tour and rental operators.
              </p>
            </FadeIn>
          </div>
        </section>
