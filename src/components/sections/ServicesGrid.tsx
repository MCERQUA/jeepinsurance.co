...
import { Shield, HeartPulse, Car, ShieldCheck, Truck, CalendarDays, Users, ArrowRight } from "lucide-react";
      ...
      <div className="container-xl">
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-bark font-bold mb-4">Insurance Built for Off-Road Operators</h2>
            <p className="font-body text-muted max-w-2xl mx-auto">
              Every coverage a commercial Jeep tour, rental, or event operator needs — from general liability and participant accident to rental fleet physical damage and special event liability.
            </p>
          </div>
        </FadeIn>
