...
const STEPS = [
  { icon: ClipboardList, step: "01", title: "Tell Us About Your Operation", desc: "Answer a few quick questions about your tours, fleet, ride volume, events, location and permits, and coverage history." },
  { icon: Search, step: "02", title: "Review Your Quote", desc: "We shop specialty recreation carriers and present competitive options — GL, participant accident, fleet physical damage, auto, events, and workers comp." },
  { icon: CheckCircle, step: "03", title: "Get Insured Today", desc: "Bind coverage and receive your certificates same-day. Certificates and additional insured endorsements issued immediately after binding." },
];
        ...
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <p className="font-body text-muted max-w-xl mx-auto">
              From initial quote to bound coverage — our process is designed for busy tour and rental operators who don't have time to waste.
            </p>
          </div>
        </FadeIn>
